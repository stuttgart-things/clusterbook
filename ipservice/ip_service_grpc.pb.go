...
const (
	...
	IpService_ReserveIpAddresses_FullMethodName = "/ipservice.IpService/ReserveIpAddresses"
)
...
type IpServiceClient interface {
	...
	ReserveIpAddresses(ctx context.Context, in *ReserveRequest, opts ...grpc.CallOption) (*IpResponse, error)
}
...
func (c *ipServiceClient) ReserveIpAddresses(ctx context.Context, in *ReserveRequest, opts ...grpc.CallOption) (*IpResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IpResponse)
	err := c.cc.Invoke(ctx, IpService_ReserveIpAddresses_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IpServiceServer interface {
	...
	// ReserveIpAddresses picks free addresses and records them for the cluster in
	// one step. The response lists them separated by ";".
	ReserveIpAddresses(context.Context, *ReserveRequest) (*IpResponse, error)
...
func (UnimplementedIpServiceServer) GetIpAddressRange(context.Context, *IpRequest) (*IpResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetIpAddressRange not implemented")
}
func (UnimplementedIpServiceServer) SetClusterInfo(context.Context, *ClusterRequest) (*ClusterResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetClusterInfo not implemented")
}
func (UnimplementedIpServiceServer) ReserveIpAddresses(context.Context, *ReserveRequest) (*IpResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReserveIpAddresses not implemented")
}
...
func _IpService_ReserveIpAddresses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReserveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IpServiceServer).ReserveIpAddresses(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IpService_ReserveIpAddresses_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IpServiceServer).ReserveIpAddresses(ctx, req.(*ReserveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IpService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReserveIpAddresses",
			Handler:    _IpService_ReserveIpAddresses_Handler,
		},
	},
