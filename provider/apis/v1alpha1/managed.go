...
func (mg *IPAssignment) SetManagementPolicies(p xpv1.ManagementPolicies) {
...
func (p *ProviderConfigUsage) SetResourceReference(r xpv1.TypedReference) { p.ResourceReference = r }
func (p *ProviderConfigUsage) GetResourceReference() xpv1.TypedReference  { return p.ResourceReference }
